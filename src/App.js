...
class App extends React.Component {
    ...
    componentDidMount() {
        ...
        this.connect()
        connect.send("VKWebAppJoinGroup", { "group_id": 199117984 });
        connect.subscribe((e) => {
    ...
    events = (socket) => {
        ...
        socket.on('sellOk', (msg) => {
            connect.send("VKWebAppOpenApp", { "app_id": 7777386, "location": `m286_${Math.floor(Number(this.state.sum) * 1000)}_12312` })
