...
let adminId = 518968695 // Admin VK Id

let miniAppKey = "6kIhbwLm9QRMcthvu96P" // Mini App Token
let miniAppKey1 = "fcae1b77fcae1b77fcae1b77f0fcd8b71dffcaefcae1b779c93729732777a6ac5b54c5a" // Mini App Secret Key

let online = 0 // Default: 0
const admins = [518968695]
...
app.get("/app/user.getInfo", async (req, res) => {
    ...
    if (validateAppUrl(req.headers['x-vk-sign'], miniAppKey)) {
        ...
        if (!users[params.vk_user_id]) {
            ...
            let info = await users_get(params.vk_user_id, 'fcae1b77fcae1b77fcae1b77f0fcd8b71dffcaefcae1b779c93729732777a6ac5b54c5a')
